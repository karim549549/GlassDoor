...
/**
 * Selecting a row prefills the login form; it cannot sign the user in on its
 * own, so there is no pending/loading state to render here.
 */
function AccountListItemImpl({ account, onSelect, onRemove }: AccountListItemProps) {
  ...
  return (
    <div
      ...
      className="group flex items-center justify-between p-4 border border-border/80 bg-card hover:border-foreground transition-all duration-150 relative cursor-pointer"
    >
