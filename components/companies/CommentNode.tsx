...
/** A single comment/reply in the community feed, recursively rendering its own replies. */
function CommentNodeImpl({ comment, onAddReply, depth = 0 }: CommentNodeProps) {
...
export const CommentNode = React.memo(CommentNodeImpl);
