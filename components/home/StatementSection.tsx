...
export function StatementSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative z-20 w-full py-28 md:py-36 px-6 md:px-12 bg-background border-b border-foreground/20 flex flex-col items-center justify-center text-center overflow-hidden"
    >
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-8 text-left">
          <div className="p-6 border border-foreground/15 bg-card/60 space-y-3 shadow-[2px_2px_0px_0px_var(--foreground)]">
