...
export function HeroSection() {
  return (
    ...
    >
      {/* Blueprint Grid Backdrop Overlay (Light Mode) */}
      <div className="absolute inset-0 opacity-[0.055] pointer-events-none z-0">
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="hero-grid" width="30" height="30" patternUnits="userSpaceOnUse">
              <path d="M 30 0 L 0 0 0 30" fill="none" stroke="#0E0E0D" strokeWidth="0.5" />
            </pattern>
          </defs>
