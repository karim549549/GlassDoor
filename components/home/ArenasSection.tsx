...
export const ArenasSection = forwardRef<HTMLDivElement, React.ComponentProps<"section">>(
  (props, ref) => {
    return (
      <section
        ref={ref}
        className="relative min-h-[720px] h-screen bg-[#F1EFE9] text-[#0E0E0D] flex flex-col justify-between py-16 px-6 md:px-12 transition-colors duration-300 overflow-visible z-10 border-b border-border"
        {...props}
      >
