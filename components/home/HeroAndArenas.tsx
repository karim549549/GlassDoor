...
export function HeroAndArenas() {
  ...
  return (
    <div ref={containerRef} className="relative overflow-visible bg-background">
      ...
      {/* SECTION 2: Pinned 3-Card Docking Arenas Section */}
      <ArenasSection ref={arenasRef} containerRef={containerRef} />

      {/* SECTION 3: The Credential & Rules Stage (.pink-section-container) */}
      ...
      {/* CHAPTER 4: Core Directive & Technical Pillars */}
      <StatementSection />

      {/* CHAPTER 5: Three-Sided Interactive Console */}
      <ThreeSidedPerspective />

      {/* CHAPTER 6: Interactive Proof Packet Cryptographic Inspector */}
      <InteractiveProofVisualizer />

      {/* CHAPTER 7: Glicko-2 Multi-Domain Mathematical Ledger */}
      <GlickoLedgerExplorer />

      {/* CHAPTER 8: Cybernetic Conversion Terminal */}
      <ConversionTerminal />
    </div>
  );
}
