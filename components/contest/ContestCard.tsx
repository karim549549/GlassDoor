...
export interface ContestCardProps {
  contest: SerializedContestListItem;
}

/**
 * Data needed to render a card's visual body. A subset of SerializedContestListItem
 ...
 */
export interface ContestCardBodyData {
  title: string;
  description: string;
...
export interface ContestCardBodyProps {
  contest: ContestCardBodyData;
...
/** Pure presentational card visuals, shared by the real ContestCard and the create-flow live preview. */
export function ContestCardBody({ contest, timeLeft, footerDate }: ContestCardBodyProps) {
...
export function ContestCard({ contest }: ContestCardProps) {
  ...
  return (
    ...
    >
      <ContestCardBody contest={contest} timeLeft={timeLeft} footerDate={contest.implPhaseStart} />
    </Link>
  );
}
