        ...
        <div className="space-y-2">
          ...
          <div className="w-full h-40 border border-[#0E0E0D]/25 bg-[#F1EFE9]/40 relative overflow-hidden flex items-center justify-center">
            ...
            <svg className="w-full h-full absolute inset-0 p-4" viewBox="0 0 100 100" preserveAspectRatio="none">
              <path d="M 5,90 L 25,60 L 45,75 L 65,40 L 85,45 L 95,30" fill="none" stroke="#0E0E0D" strokeWidth="1.5" />
              <path
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex gap-1">
                  {"█░░▒▓██░░▒▓██░░▒▓█".split("").map((char, i) => (
                    <span
                      key={i}
                      className={`w-3.5 h-3.5 border border-[#0E0E0D]/10 flex items-center justify-center font-sans font-bold text-[0.55rem] ${
                        char === "█"
                          ? "bg-orange text-[#FAF8F5]"
                          : char === "▓"
                            ? "bg-orange/60 text-[#FAF8F5]"
                            : char === "▒"
                              ? "bg-orange/30 text-[#0E0E0D]"
                              : "bg-[#F1EFE9] text-[#0E0E0D]/30"
                      }`}
                    >
                      {char}
                    </span>
