    ...
    <div className="md:col-span-2 border border-[#0E0E0D] bg-[#FAF8F5] p-6 font-mono text-[0.65rem] uppercase tracking-wider relative shadow-[4px_4px_0px_0px_rgba(14,14,13,0.1)] flex flex-col justify-between">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-1.5 lowercase first-letter:uppercase text-[0.7rem] normal-case leading-relaxed text-[#0E0E0D]/85">
          <span className="font-bold font-mono text-[0.65rem] uppercase tracking-widest text-[#0E0E0D] block mb-1">
            About Bio:
          </span>
        ...
        <div className="border-t border-[#0E0E0D]/10 pt-3 space-y-2.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1.5 text-muted-foreground font-mono">
            <div className="flex justify-between border-b border-[#0E0E0D]/5 pb-1">
              <span>Job Title</span>
              <span className="font-bold text-[#0E0E0D] text-right max-w-[65%] truncate">{specialty || "None"}</span>
            </div>
            <div className="flex justify-between border-b border-[#0E0E0D]/5 pb-1">
              <span>Seniority</span>
              <span className="font-bold text-[#0E0E0D]">{seniority || "None"}</span>
            </div>
            <div className="flex justify-between border-b border-[#0E0E0D]/5 pb-1">
              <span>Status</span>
              <span className="font-bold text-[#0E0E0D]">{employmentStatus || "None"}</span>
            </div>
            <div className="flex justify-between border-b border-[#0E0E0D]/5 pb-1">
              <span>Employer</span>
              <span className="font-bold text-[#0E0E0D]">{currentEmployer || "None"}</span>
            </div>
            <div className="flex justify-between border-b border-[#0E0E0D]/5 pb-1">
              <span>Education</span>
              <span className="font-bold text-[#0E0E0D] text-right max-w-[65%] truncate">{education || "None"}</span>
            </div>
            <div className="flex justify-between border-b border-[#0E0E0D]/5 pb-1">
              <span>Location</span>
              <span className="font-bold text-[#0E0E0D] text-right max-w-[65%] truncate">{location || "None"}</span>
            </div>
          </div>
        </div>
      </div>
