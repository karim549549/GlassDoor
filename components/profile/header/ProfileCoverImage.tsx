  ...
  return (
    <>
      ...
      {isOwner && (
        <button
          onClick={onEditClick}
          className="absolute top-20 right-6 p-2 bg-background text-foreground border border-foreground font-mono text-[0.55rem] uppercase tracking-wider font-bold hover:bg-foreground hover:text-background transition-colors cursor-pointer flex items-center gap-1.5 shadow-[2px_2px_0px_0px_rgba(14,14,13,0.15)] z-30 hover:shadow-none active:translate-x-0.5 active:translate-y-0.5"
        >
